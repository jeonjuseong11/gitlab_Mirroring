...
const TermYoungPrivate = () => {
  return (
    <div>
      ...
      >
        <p>
          HIGHWAY(하이웨이)(이하 '회사'라고 합니다)는 청소년이 건전한 인격체로
        ...
        <ul style={{ listStyle: "none", textAlign: "left" }}>
          ...
          <li>
            이용자 분들께서는 하단에 명시한 "4. HIGHWAY 청소년보호 책임자 및
            담당자의 소속, 성명 및 연락처" 항을 참고하여 전화나 메일을 통하여
            피해상담 및 고충처리를 요청할 수 있습니다.
          </li>
        </ul>
        <ul style={{ listStyle: "none", textAlign: "left" }}>
          <h4>4. HIGHWAY 청소년보호 책임자 및 담당자의 소속, 성명 및 연락처</h4>
          <li>
            HIGHWAY는 청소년들이 좋은 정보를 안전하게 이용할 수 있도록 최선을
            다하고 있습니다.
          </li>
        </ul>
      </div>
...
export default TermYoungPrivate;
