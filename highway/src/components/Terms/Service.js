    ...
    <TermWrapper>
      ...
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          ...
          개인정보취급방침을 읽고 "동의" 또는 "확인" 버튼을 누른 경우 본 약관에
          동의하여 신청한 것으로 간주한다.
        </li>
        <li>
          ２. "신청자"는 신청에 있어 "회사"에게 사업자정보와 신청자 본인 여부를
          확인하기 위해 인증에 필요한 정보를 제공하여야 하며, 전문기관을 통한
          인증 절차를 거칠 수 있다.
        </li>
        <li>
          ３. "회사"는 인증 과정에서 필요 시 "신청자에게" 사업자정보를 확인할 수
          있는 증명서(사업자등록증), 재직증명서 등을 별도로 요구할 수 있다.
        </li>
        <li>
          ４. "신청자"가 사업자등록번호가 없는 기관이나 단체, "사이트"에 제공된
          수단으로 본인인증이 불가한 경우 "회사"가 정한 별도의 절차에 따라
          이용계약을 할 수 있다.
        </li>
      </ul>
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          1. "회사"는 전조의 규정에 의한 이용신청 고객에 대하여 업무수행상 또는
      ...
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          1. "신청자"는 구직자들이 채용공고를 열람한 후 해당 기업에 대한 판단을
          돕기 위해 기업정보를 정확히 기재하여야 한다.
        </li>
        <li>
      ...
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          2. "회사"는 서비스와 관련한 회원의 불만사항이 접수되는 경우 이를 즉시
          처리하여야 하며, 즉시 처리가 곤란한 경우에는 그 사유와 처리일정을
          서비스 화면 또는 기타 방법을 통해 동 회원에게 통지하여야 한다.
        </li>
        <li>
          3. "회사는" 천재지변 등 예측하지 못한 일이 발생하거나 시스템의 장애가
          발생하여 서비스가 중단될 경우 이에 대한 손해에 대해서는 책임을 지지
          않는다. 다만 자료의 복구나 정상적인 서비스 지원이 되도록 최선을 다할
          의무를 진다.
        </li>
        <li>
          ４. "회사"는 본 서비스를 이용하여 기대하는 수익을 얻지 못하거나 상실한
          것에 대하여 책임을 지지 않으며, 회사가 무료로 제공하는 서비스의 이용과
          관련하여 개인정보취급방침에서 정하는 내용에 위반하지 않은 한 어떠한
          손해도 책임지지 않는다.
        </li>
      </ul>
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          4. "회사"는 기업정보 및 채용공고를 "회사"가 정한 방법에 의해 노출할 수
          있다.
        </li>
        <li>
          5. "회사"는 "신청자"가 등록한 "자료 내용" 에 오자, 탈자 또는 사회적
          통념에 어긋나는 문구와 내용이 있을 경우, 임의로 이를 언제든지 수정 및
          비공개 처리할 수 있다.
        </li>
        <li>
          6. "자료 내용" 및 채용 과정에서 수집된 정보는 취업 및 관련 동향의 통계
          자료로 활용될 수 있으며, 매체를 통해 언론에 배포될 수 있다. 단,
          활용되는 정보 중 개인을 식별할 수 있는 개인정보는 제외된다.
        </li>
        <li>
          7. "회사"는 제휴 관계를 체결한 여타 인터넷 서비스 및 채용박람회 또는
          신문, 잡지 등의 오프라인 매체를 통해 사이트에 등록한 "신청자"의
          기업정보와 채용공고가 열람될 수 있도록 서비스를 제공할 수 있다. 이 때,
          "회사"는 제휴를 통해 타 사이트 및 매체에 등록될 수 있음을 고지하고
          동의를 받아야 하며, 제휴 사이트 전체 목록을 사이트내에서 상시 열람할
          수 있도록 해야 한다.
        </li>
        <li>
      ...
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          • 사업자등록증에 나타난 정보와 기업회원 가입시의 정보가 일치하지 않을
          때
        </li>
        <li>
          • 타 기업의 사업자등록번호나 상호를 도용하여 허위로 기업정보를 등록한
          경우
        </li>
        <li>
        ...
        <li>
          • 작성자가 제시한 직종, 업무내용, 근로조건 등이 실제와 현저히 다를 때
        </li>
        <li>• 채용공고의 모집요강만으로 업무에 대한 내용이 명확하지 않을 때</li>
        ...
        <li>
          • 회원모집 형태의 광고 또는 카드회원 모집(수당제 광고) 내용을 등록했을
          때
        </li>
        <li>
        ...
        <li>
          • 본 "서비스"에서 안내하는 방법으로 가입하지 않았거나 등록하지 않았을
          때
        </li>
        ...
        <li>
          • 타인/타법인 으로부터 허위사실 및 명예훼손 등으로 삭제 요청이 접수된
          경우
        </li>
        <li>
          • 기타 관계법규에 위배되는 내용이거나 "서비스"의 원활한 운영을 위하여
          운영자가 필요하다고 판단한 경우
        </li>
      </ul>
      <ul style={{ listStyle: "none", textAlign: "left" }}>
        ...
        <li>
          ...
          인하여 "유료서비스"를 제공할 수 없는 경우에는 "유료서비스" 제공에 관한
          책임이 면제된다.
        </li>
        <li>
        ...
        <li>
          13. "회사"는 "신청자" 상호간 또는 "신청자"과 제3자 간에 "유료서비스"를
